...
String path = "/Nodes/4/"; //<--Cambiar por el ID correspondiente
...
void loop(){
  ...
  if(error) {
    ...
    if(timePassed > 5){
      ...
      Firebase.pushDouble(firebaseData, path + subPath + "/SpecialSensor/SpecialSensorReading",specialSensorReading);
